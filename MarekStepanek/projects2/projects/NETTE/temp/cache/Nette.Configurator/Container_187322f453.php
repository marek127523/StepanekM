...
class Container_187322f453 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\PrijmeniProduktPresenter' => [1 => ['application.2']],
			'App\Presenters\FousekPresenter' => [1 => ['application.3']],
			'App\Presenters\SignPresenter' => [1 => ['application.4']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.5']],
			'App\Presenters\DavidPresenter' => [1 => ['application.6']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.7']],
			'App\Presenters\FousekContactPresenter' => [1 => ['application.8']],
		...
		'services' => [
			...
			'application.2' => 'App\Presenters\PrijmeniProduktPresenter',
			'application.3' => 'App\Presenters\FousekPresenter',
			'application.4' => 'App\Presenters\SignPresenter',
			'application.5' => 'App\Presenters\ErrorPresenter',
			'application.6' => 'App\Presenters\DavidPresenter',
			'application.7' => 'App\Presenters\HomepagePresenter',
			'application.8' => 'App\Presenters\FousekContactPresenter',
	...
	public function createServiceApplication__2(): App\Presenters\PrijmeniProduktPresenter
	{
	...
	public function createServiceApplication__3(): App\Presenters\FousekPresenter
	{
	...
	public function createServiceApplication__6(): App\Presenters\DavidPresenter
	{
	...
	public function createServiceApplication__8(): App\Presenters\FousekContactPresenter
	{
